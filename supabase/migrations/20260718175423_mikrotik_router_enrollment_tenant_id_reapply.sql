-- Re-apply tenant_id migration for MikroTik routers + router_enrollment under a unique version.
-- The repository previously had a version collision at 20260717040000, so staging
-- registered onboarding_status_fail_closed while these additive tenant_id changes
-- still needed to run.
