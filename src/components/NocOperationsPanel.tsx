...
// ====================================================================
// NOC Operations Panel — herramientas operativas del NOC.
//
// Reubicado desde el Dashboard Ejecutivo (Dashboard V3): el dashboard del
// dueño quedó como pantalla de decisión rápida (8 KPIs + alertas + acciones),
// y todo el tooling técnico/operativo del NOC vive aquí, montado bajo el tab
// "NOC". NO se eliminó funcionalidad del sistema; solo se movió de lugar.
//
// Incluye: feed de alertas en tiempo real, métricas rápidas de red, bot de
// cobranza (automatización), diagnóstico de ping, configuración de umbrales /
// push notifications (Telegram/WhatsApp) y la consola simuladora de eventos.
//
// Mantiene EXACTAMENTE los mismos estilos (slate/indigo, tema oscuro) y
// comportamiento que tenía en el dashboard. Sin tema nuevo.
// ====================================================================

interface NocOperationsPanelProps {
  stats: any;
  alerts: NocAlert[];
...
export default function NocOperationsPanel({
  stats,
  alerts,
  onAcknowledgeAlerts,
  onRefresh,
  ...
  return (
    <div id="noc-operations-panel" className="space-y-6 text-slate-100 font-sans">
