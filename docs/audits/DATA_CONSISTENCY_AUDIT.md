...
| **Suspendidos** | **Service Status** (`serviceStatus === SUSPENDED`) | Dashboard, Client 360 | CRM `status` ya NO es la fuente del KPI — ver [SERVICE_STATUS_SSOT_RESULT.md](../results/SERVICE_STATUS_SSOT_RESULT.md) |
