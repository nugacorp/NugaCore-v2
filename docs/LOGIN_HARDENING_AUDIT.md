...
Los usuarios **reales de staging** son distintos (`@staging.nugacore.local`, ver [STAGING_AUTH_USERS.md](STAGING_AUTH_USERS.md)) → confusión entre demo y staging confirmada (hallazgo #3 de Hermes).
