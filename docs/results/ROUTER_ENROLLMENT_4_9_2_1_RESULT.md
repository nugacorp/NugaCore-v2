...
>
> Diseño técnico: [`ROUTER_ENROLLMENT_WIREGUARD_SNAPSHOT.md`](../wireguard/ROUTER_ENROLLMENT_WIREGUARD_SNAPSHOT.md)
> y [`ROUTER_ENROLLMENT_ROUTER_SNAPSHOT.md`](../wireguard/ROUTER_ENROLLMENT_ROUTER_SNAPSHOT.md).
