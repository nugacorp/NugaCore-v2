...
- Arquitectura → [SYSTEM_ARCHITECTURE.md](../architecture/SYSTEM_ARCHITECTURE.md)
- Módulos → [MODULES_ANALYSIS.md](../frontend/MODULES_ANALYSIS.md)
- Base de datos → [DATABASE_ANALYSIS.md](../architecture/DATABASE_ANALYSIS.md)
- API → [API_ANALYSIS.md](../architecture/API_ANALYSIS.md)
- Seguridad → [SECURITY_AUDIT.md](../audits/SECURITY_AUDIT.md)
- Deuda técnica → [TECHNICAL_DEBT.md](../architecture/TECHNICAL_DEBT.md)
