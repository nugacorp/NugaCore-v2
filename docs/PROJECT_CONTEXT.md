...
Estas decisiones ya están **ratificadas** (ver [DATA_CONTRACT.md](DATA_CONTRACT.md) y `MASTER_PLAN.md`):
...
> Clasificación detallada en [SECURITY_AUDIT.md](SECURITY_AUDIT.md) y [TECHNICAL_DEBT.md](TECHNICAL_DEBT.md).
