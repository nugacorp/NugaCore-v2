...
- Arquitectura de billing: [BILLING_ARCHITECTURE.md](../billing/BILLING_ARCHITECTURE.md)
- Plan maestro de fases: [NUGACORE_ROADMAP.md](../planning/NUGACORE_ROADMAP.md)
- Plan detallado Fase 4.8: [PAYMENT_ENGINE_PHASE_PLAN.md](../planning/PAYMENT_ENGINE_PHASE_PLAN.md)
- Roadmap de billing: [BILLING_ROADMAP.md](../planning/BILLING_ROADMAP.md)
- Auditoría Fase 4.7: [WIREGUARD_AUTO_ENROLLMENT_REVIEW.md](../audits/WIREGUARD_AUTO_ENROLLMENT_REVIEW.md)
- Hotfix Fase 4.7: [WIREGUARD_AUTO_ENROLLMENT_REVIEW_FIXES.md](../audits/WIREGUARD_AUTO_ENROLLMENT_REVIEW_FIXES.md)
